...
import { idlFactory } from './memory_assistant.did.js';
export { idlFactory } from './memory_assistant.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.MEMORY_ASSISTANT_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./memory_assistant.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the memory_assistant canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./memory_assistant.did.js")._SERVICE>}
 */
export const memory_assistant = createActor(canisterId);
